...
class EwycdSimulation extends Simulation {
  ...
  val scn = scenario("EwycdSimulation")
    .exec(http("introduction")
      .get("/work-you-could-do/deaa1098-46bf-42af-b85d-03909158bc3e/introduction"))
    //		.pause(1)
    .exec(http("search")
    .get("/work-you-could-do/deaa1098-46bf-42af-b85d-03909158bc3e/search/new"))
    //		.pause(1)
    .exec(http("search_with_Retail")
    .get("/work-you-could-do/deaa1098-46bf-42af-b85d-03909158bc3e/search?query=Retail"))
    //		.pause(1)
    .exec(http("role_details")
    .get("/work-you-could-do/deaa1098-46bf-42af-b85d-03909158bc3e/occupations/1254?from_query=Retail")
    .check(css("""input[name="authenticity_token"]""", "value").saveAs("authenticity_token")))
    //		.pause(1)
    .exec(http("role_details_save")
    .post("/work-you-could-do/deaa1098-46bf-42af-b85d-03909158bc3e/saved_occupations")
    .headers(headers_4)
    .formParam("utf8", "✓")
    ...
    .post("/work-you-could-do/deaa1098-46bf-42af-b85d-03909158bc3e/saved_occupations/1254")
    .headers(headers_4)
    .formParam("utf8", "✓")
