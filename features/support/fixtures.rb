...
module Fixtures
  SEARCH_RESULTS = {
    "library" => [
      ...
      { soc: 1259, title: "Managers and proprietors in other services", description: "Job holders in this unit group perform a variety of managerial tasks in other service industries." },
  ...
  def specific_search_result
    {
      ...
      additional_titles: "Library Assistant; Services, Bibliographic Assistant; Library Supervisor; Book Looker Out; Abstractor; Library Clerk; Bibliographic Assistant; Cutting, Press Agent; Cuttings, Press Clerk; Resource, Learning Assistant; Archives Assistant; Library Attendant",
      week_hours: 39,
      week_pay: 710,
    }
  end
